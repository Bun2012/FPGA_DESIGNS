...
HD_PWD='L:/Xilinx_Training/Lab3/processes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_bridge.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reset_bridge.tcl
